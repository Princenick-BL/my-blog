  ...
  return (
    <>
      ...
      >
        ...
        <amp-story-page id="page-1" style = {{border: "1px solid red", borderRadius : "10px ",width:"calc( 100% - 2px )"}}>
        ...
        <amp-story-page id="page-2"  style = {{border: "1px solid red", borderRadius : "10px ",width:"calc( 100% - 2px )"}}>
          <amp-story-grid-layer template="fill">
            <amp-video
              autoplay=""
              loop=""
        ...
        <amp-story-page id="animation-demo"  style = {{border: "1px solid red", borderRadius : "10px ",width:"calc( 100% - 2px )"}}>
          <amp-story-grid-layer template="fill">
            <amp-img
        ...
        <amp-story-page id="layout-demo"  style = {{border: "1px solid red", borderRadius : "10px ",width:"calc( 100% - 2px )"}}>
          <amp-story-grid-layer template="thirds">
            <amp-img
